...
export default function Privilege() {
  ...
  return (
    <div className="flex-1 flex flex-row items-start justify-start p-5 pb-10 gap-4 bg-[#0093e8] relative">
      ...
      <div className="absolute w-full -bottom-27 left-0 px-5">
