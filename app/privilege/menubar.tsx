  ...
  return (
    <footer className="flex-none p-4 bg-white border-t border-gray-100 space-y-4">
                ...
                <div className="flex justify-around">
                    ...
                    <div className="flex flex-col items-center text-gray-800 opacity-50">
                    ...
                    <div className="flex flex-col items-center relative w-20"  >
                        <button onClick={() => { router.push('/privilege/my-qrcode') }} className="w-22 h-22 rounded-full bg-[#ffffff] flex flex-col items-center justify-center shadow-md absolute -top-12 left-1/2 transform -translate-x-1/2 overflow-hidden border-4 border-gray-200">
